...
class UpandOutBarrier_European_Call_Payoff:
    ...
    def __init__(self, strike, barrier_level1=0, barrier_level2=0, barrier_level3=0, barrier_level4=0, barrier_level5=0, barrier_level6=0):
...
def main():
    ...
    for price_path in price_paths:
        ...
        bc_case1 = UpandOutBarrier_European_Call_Payoff(strike_price, 110)  # 110 is the barrier price
        bc_case2 = UpandOutBarrier_European_Call_Payoff(strike_price, 110, 108)
        bc_case3 = UpandOutBarrier_European_Call_Payoff(strike_price, 105, 106, 107, 108, 109, 110)
        bc_case41 = UpandOutBarrier_European_Call_Payoff(strike_price, 110)
        bc_case42 = UpandOutBarrier_European_Call_Payoff(strike_price, 110)
        bc_case43 = UpandOutBarrier_European_Call_Payoff(strike_price, 110)
    ...
    print('European Case41 Option simulation price is: ', np.average(case41_call_payoffs))
    print('European Case42 Option simulation price is: ', np.average(case42_call_payoffs))
    print('European Case43 Option simulation price is: ', np.average(case43_call_payoffs))
