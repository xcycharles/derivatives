...
Yaxis = np.linspace(0.0, 2, 400)  # 400 steps for maturity/365
Xaxis = np.linspace(2.0, 5.0, 100)  # 100 steps for spot price is just right for graph showing
underlying = Localvol.LocalVol('510050')
...
plt.title('Local Vol Surface 510050 call')
plt.xlabel('Strike')
plt.ylabel('Maturity')
